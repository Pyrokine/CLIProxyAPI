...
// Storage is a no-operation implementation of the TokenStorage interface.
...
// noinspection GoUnusedExportedType — intentional: empty implementation available for future use.
type Storage struct {
...
func (ts *Storage) SaveTokenToFile(_ string) error {
	ts.Type = "empty"
	return nil
}
