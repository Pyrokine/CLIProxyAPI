...
func ComputeOpenAICompatModelsHash(models []config.OpenAICompatibilityModel) string {
	return summarizeModelPairs(
		models,
		func(m config.OpenAICompatibilityModel) (string, string) { return m.Name, m.Alias },
	).hash
}
...
func ComputeVertexCompatModelsHash(models []config.VertexCompatModel) string {
	return summarizeModelPairs(
		models,
		func(m config.VertexCompatModel) (string, string) { return m.Name, m.Alias },
	).hash
}

// ComputeClaudeModelsHash returns a stable hash for Claude model aliases.
func ComputeClaudeModelsHash(models []config.ClaudeModel) string {
	return summarizeModelPairs(models, func(m config.ClaudeModel) (string, string) { return m.Name, m.Alias }).hash
}
...
func ComputeCodexModelsHash(models []config.CodexModel) string {
	return summarizeModelPairs(models, func(m config.CodexModel) (string, string) { return m.Name, m.Alias }).hash
}
...
func ComputeGeminiModelsHash(models []config.GeminiModel) string {
	return summarizeModelPairs(models, func(m config.GeminiModel) (string, string) { return m.Name, m.Alias }).hash
}
