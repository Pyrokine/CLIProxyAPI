...
func ConvertOpenAIResponseToOpenAI(_ context.Context, _ string, _, _, rawJSON []byte, _ *any) [][]byte {
...
func ConvertOpenAIResponseToOpenAINonStream(_ context.Context, _ string, _, _, rawJSON []byte, _ *any) []byte {
	return rawJSON
}
